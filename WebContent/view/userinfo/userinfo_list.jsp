...
<div>
    ...
    <div class="container">
        <form method="post" action="userInfListServlet" class="form-inline" role="form">
            ...
            <div class="form-group">
                <label for="">部门</label>
                <input type="text" name="userDepartment" class="form-control"  placeholder="请输入部门">
            </div>
            <div class="form-group">
                <label for="">&nbsp;</label>
                <br/>
        ...
        <d:table name="list" class="table table-striped" pagesize="5" requestURI="userInfListServlet">
            <d:column property="userId" title="编号"></d:column>
            <d:column property="userName" title="姓名"></d:column>
            <d:column property="userDepartment" title="部门"></d:column>
            ...
            <d:column href="userInfoUpdateServlet" paramId="userId" paramProperty="userId" value="修改"
                      title="修改"></d:column>
            <d:column href="userInfoDeleteServlet" value="删除" paramId="userId" paramProperty="userId"
                      title="删除"></d:column>
        </d:table>
    </div>
