...
<body>
<div  >
	<h4 class="page-header">用户管理<small>用户查询</small></h4>

<div class="container">
<form  method="post" action="userInfoQueryServlet" class="form-inline" role="form">
...
<d:table name="list"  class="table table-striped" pagesize="5" requestURI="userInfoQueryServlet">
	...
	<d:column href="userInfoShowServlet" paramId="userId" paramProperty="userId" value="查看" title="查看"></d:column>
