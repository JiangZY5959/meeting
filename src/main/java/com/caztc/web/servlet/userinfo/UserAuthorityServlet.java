...
/**
 * Servlet implementation class UserAuthorityServlet
 */
@WebServlet("/userAuthorityServlet")
public class UserAuthorityServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UserAuthorityServlet() {
        super();
